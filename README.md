...
- [pi-hole](https://pi-hole.net/): có lẽ là ứng dụng chặn quảng cáo cho mạng nội bộ phổ biến nhất. Phát triển ban đầu cho dòng Raspberry Pi nhưng hiện tại có thể chạy trên nhiều thiết bị và nền tảng khá
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTEyNzA0MjQ0NjgsLTE1MTI3MTU4NjcsMT
