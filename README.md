...
**Lưu ý**: Nếu trình duyệt tích hợp sẵn tính năng DNS mã hóa và kết nối tới DNS-không-có-chặn-quảng-cáo của họ thì cần tắt tính năng DNS mã hóa này đi.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwOTIxMDE5NzAsMTMyNjM4MDgxMiwtMT
