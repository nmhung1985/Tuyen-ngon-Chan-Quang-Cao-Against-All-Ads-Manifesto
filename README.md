...
- Có lẽ cũng là cách dễ nhất, vì hệ thống DNS ở xa xử lý rồi nên bạn không cần cấu hình, cài đặt gì phức tạp, và áp dụng được trên tất cả nền tảng (do DNS là yếu tố cơ bản để một hệ thống mạng hoạt động). Ngoại trừ một số phiên bản Android (Oreo) không thay đổi được DNS nếu không root.
...
3. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMzMzNDA5OTU0LDU3NjAwNTQyOSwtMTk5Mj
