...
- Áp dụng được trên tất cả nền tảng (do DNS là yếu tố cơ bản để một hệ thống mạng hoạt động). Ngoại trừ một số phiên bản Android (Oreo) không thay đổi được DNS nếu không root.
...
3. 
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTk5NjQxNDg2NSw1NzYwMDU0MjksLTE5OT
