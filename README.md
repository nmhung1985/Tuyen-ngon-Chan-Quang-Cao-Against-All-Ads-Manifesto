...
- [ABPVN của hoangrio](https://github.com/abpvn/abpvn): có mặt chính thức trong vài ứng dụng nổi tiếng như Adblock Plus (tên nhóm lấy từ đây), uBlock Origin, v.v... , áp dụng được cho 2 nguyên lý nên hoạt động trên ít ứng dụng hơn (chủ yếu là cho các tiện ích cài bổ sung trình duyệt).
...
Các ứng dụng được liệt kê theo đánh giá cá nhân người viết dựa trên *cảm nhận tổng hợp* của lần lượt bốn yếu tố: tốt nhất, miễn phí, dễ cài đặt, trả phí. Thành ra ví dụ nếu ứng dụng trả phí vượt trội thì vẫn sẽ được liệt kê trước.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTIwODkyODM2MTAsLTc4ODc3MjgzMSwxMz
